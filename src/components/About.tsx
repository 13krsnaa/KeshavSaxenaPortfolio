      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 md:gap-12 lg:gap-16">
          <div className="min-w-0">
            ...
            <div className="space-y-2.5 sm:space-y-3 md:space-y-4 text-sm sm:text-base leading-relaxed">
              <p className="break-words text-glow">
          ...
          <div className="min-w-0 mt-6 md:mt-0">
            ...
            <div className="space-y-2.5 sm:space-y-3 md:space-y-4">
              <div>
                <div className="code-tag mb-1.5 sm:mb-2 w-fit text-[9px] sm:text-[10px] md:text-xs whitespace-nowrap text-glow">Programming Languages</div>
                <Marquee
                  items={[
